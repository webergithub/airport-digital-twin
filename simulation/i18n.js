...
const DICT = {
  ...
  'stat.throughput': { zh: '吞吐/仿真时', en: 'Moves/sim-hr' },
  ...
  'an.throughput': { zh: '吞吐/仿真时',  en: 'Moves/sim-hr' },
  ...
  'apoc.h.throughput': { zh: '吞吐/仿真时', en: 'Thrpt/sim-h' },
  ...
  // ── 容量申报与时刻协调 (WASG) ──
  'panel.wasg':  { zh: '📅 容量申报与时刻 (WASG)', en: '📅 Capacity & Slots (WASG)' },
  'dock.d.wasg': { zh: '申报容量·时刻分配·计划符合性', en: 'Declared capacity, slot plan & adherence' },
  'wasg.level':      { zh: '协调等级 Level {n}', en: 'Coordination Level {n}' },
  'wasg.adherence':  { zh: '计划符合率', en: 'Adherence' },
  'wasg.allocated':  { zh: '已分配时刻', en: 'Allocated' },
  'wasg.rejected':   { zh: '容量拒绝', en: 'Refused' },
  'wasg.meanSd':     { zh: '偏离均值/标准差', en: 'Mean/SD dev' },
  'wasg.rwyMode':    { zh: '当前按 {n} 跑道申报参数', en: 'Parameters for {n}-runway mode' },
  'wasg.misuse':     { zh: '⚠ 偏离持续且集中 — 符合 Annex 12.9 结构性时刻滥用特征', en: '⚠ Consistent, tight deviation — Annex 12.9 structural slot-misuse signature' },
  'wasg.v.pending':      { zh: '样本不足，暂不判定申报容量', en: 'Too few records to judge the declaration' },
  'wasg.v.overDeclared': { zh: '平均延误超判据 — 申报容量可能定得过高', en: 'Mean delay over criterion — capacity may be over-declared' },
  'wasg.v.balanced':     { zh: '平均延误在判据内 — 申报容量与需求匹配', en: 'Delay within criterion — declaration matches demand' },
  'wasg.v.headroom':     { zh: '延误远低于判据 — 申报容量尚有余量', en: 'Delay well under criterion — headroom in the declaration' },
  'wasg.k.arr':      { zh: '到港', en: 'ARR' },
  'wasg.k.dep':      { zh: '离港', en: 'DEP' },
  'wasg.intervals':  { zh: '滚动窗口占用 (R60/R10)', en: 'Rolling windows (R60/R10)' },
  'wasg.recent':     { zh: '最近到位（计划 vs 实际）', en: 'Recent in-block (plan vs actual)' },
  'wasg.onSlot':     { zh: '符合', en: 'ON SLOT' },
  'wasg.offSlot':    { zh: '偏离', en: 'OFF SLOT' },
  'wasg.none':       { zh: '暂无记录', en: 'No records yet' },
  'apoc.kpi.wasg':   { zh: '时刻计划符合率', en: 'Slot adherence' },
  ...
  'wl.strikes':   { zh: '鸟击(接触)', en: 'Strikes' },
