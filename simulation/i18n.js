...
const DICT = {
  ...
  'dock.railLbl':  { zh: '展开/收起本栏名称', en: 'Show / hide this rail\'s names' },
  'dock.rails':    { zh: '显示哪些栏', en: 'Rails shown' },
  'dock.iconSize': { zh: '图标大小', en: 'Icon size' },
  ...
  'apoc.kpi.deiceQueue':   { zh: '除冰排队', en: 'De-ice queue' },
  ...
  'live.st.demo':       { zh: '已连接：演示回放数据源（近 2 分钟）', en: 'Connected: demo replay source (last ~2 min)' },
  'live.demo':          { zh: '▶ 演示数据源', en: '▶ Demo source' },
  'live.demoNeed':      { zh: '演示需要先运行片刻积累数据，请稍后再试', en: 'Demo needs a little run history first — try again shortly' },
  'log.demoOn':         { zh: '🔗 演示数据源已接入：回放近 2 分钟运行（本地模拟暂停）', en: '🔗 Demo source connected — replaying the last ~2 min (local sim paused)' },
  'log.demoOff':        { zh: '演示数据源已断开，本地模拟恢复', en: 'Demo source disconnected — local sim resumed' },
  ...
  'grf.aireps':    { zh: '机组刹车效应报告 (AIREP)', en: 'Pilot braking reports (AIREP)' },
  'grf.changes':   { zh: '状态码变更', en: 'Code changes' },
  'grf.noAireps':  { zh: '暂无报告（干跑道不报）', en: 'None (dry runway — not reported)' },
  'grf.noChanges': { zh: '暂无变更', en: 'No changes yet' },
  'grf.c.dry':      { zh: '干', en: 'DRY' },
  'grf.c.wet':      { zh: '湿', en: 'WET' },
  'grf.c.wetHeavy': { zh: '湿(大雨)', en: 'WET (heavy)' },
  'grf.c.standing': { zh: '积水', en: 'STANDING WATER' },
  'grf.c.slush':    { zh: '雪浆', en: 'SLUSH' },
  'grf.c.ice':      { zh: '冰', en: 'ICE' },
  'grf.b.good':       { zh: '刹车良好', en: 'GOOD' },
  'grf.b.goodMedium': { zh: '良至中等', en: 'GOOD-MEDIUM' },
  'grf.b.medium':     { zh: '中等', en: 'MEDIUM' },
  'grf.b.mediumPoor': { zh: '中至差', en: 'MEDIUM-POOR' },
  ...
  'dock.d.slots':  { zh: 'CTOT 时隙窗·符合率·在场风险', en: 'CTOT windows, adherence & live risk' },
  'slots.adh':     { zh: '时隙符合率', en: 'Adherence' },
  'slots.closed':  { zh: '已关闭', en: 'Closed' },
  'slots.early':   { zh: '早于窗', en: 'Early' },
  'slots.late':    { zh: '晚于窗', en: 'Late' },
  'slots.open':    { zh: '在场受控时隙', en: 'Open regulated slots' },
  'slots.recent':  { zh: '最近关闭', en: 'Recently closed' },
  'slots.none':    { zh: '暂无', en: 'None yet' },
  'slots.st.ok':     { zh: '正常', en: 'OK' },
  'slots.st.risk':   { zh: '有风险', en: 'AT RISK' },
  'slots.st.missed': { zh: '已错失', en: 'MISSED' },
  'slots.v.compliant': { zh: '符合', en: 'Compliant' },
  'slots.v.early':     { zh: '早', en: 'Early' },
  'slots.v.late':      { zh: '晚', en: 'Late' },
  'apoc.kpi.slotAdh':  { zh: '时隙符合率', en: 'Slot adherence' },
  ...
  'deice.off':        { zh: '冬季除冰未启用。可在「情景推演」中开启冻雨/除冰。',
                        en: 'Winter de-icing inactive. Enable freezing/de-icing in the What-If console.' },
  'deice.inProcess':  { zh: '除冰进行中', en: 'In process' },
  'deice.pads':       { zh: '除冰位', en: 'Pads' },
  'deice.queue':      { zh: '排队', en: 'Queue' },
  'deice.treated':    { zh: '已除冰', en: 'Treated' },
  'deice.avgWait':    { zh: '平均等待', en: 'Avg wait' },
  'deice.hotBreach':  { zh: 'HOT 超时', en: 'HOT breach' },
  'deice.expired':    { zh: 'HOT 超时', en: 'HOT expired' },
  'deice.none':       { zh: '暂无航班除冰', en: 'No flights in de-icing' },
  'deice.st.queued':  { zh: '排队', en: 'Queued' },
  'deice.st.deicing': { zh: '除冰中', en: 'De-icing' },
  'deice.st.holdover':{ zh: '保持中', en: 'Holdover' },
